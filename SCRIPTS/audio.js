...
const audio=products.filter((product)=>{return product.category==='audio'})

export function renderAudio () {
  let audioHTML='';

  audio.forEach((product)=>{audioHTML+=
    `
  ...
  document.querySelector('.js-audio-grid').innerHTML=audioHTML;
}
renderAudio();
...
const productsGrid = document.querySelector(".js-audio-grid");

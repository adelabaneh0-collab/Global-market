...
const footWear=products.filter((product)=>{return product.category==='footwear'})

export function renderFootwear () {
  let footWearHTML='';

  footWear.forEach((product)=>{footWearHTML+=
    `
  ...
  document.querySelector('.js-foot-wear-grid').innerHTML=footWearHTML;
}
...
const productsGrid = document.querySelector(".js-foot-wear-grid");

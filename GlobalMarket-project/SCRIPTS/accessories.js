...
const accessories=products.filter((product)=>{return product.category==='accessories'})

export function renderAccessories () {
  let accessoriesHTML='';

  accessories.forEach((product)=>{accessoriesHTML+=
    `
...
const productsGrid = document.querySelector(".js-accessories-grid");
